...
const sectionFields: Record<string, FieldDef[]> = {
  ...
  events_page_content: [
    { key: "events_page_title", label: "Section Title", placeholder: "Event Management Services in Bangladesh" },
    { key: "events_page_description", label: "Long Description (HTML)", type: "richtext" as const, fullWidth: true },
    { key: "events_page_motto", label: "Motto / Tagline", placeholder: "Making every moment unforgettable" },
    { key: "events_page_image_1", label: "Image 1", type: "image_upload" as const },
    { key: "events_page_image_2", label: "Image 2", type: "image_upload" as const },
    { key: "events_page_image_3", label: "Image 3", type: "image_upload" as const },
    { key: "events_page_faq_1_question", label: "FAQ 1 Question" },
    { key: "events_page_faq_1_answer", label: "FAQ 1 Answer", type: "textarea" as const, fullWidth: true },
    { key: "events_page_faq_2_question", label: "FAQ 2 Question" },
    { key: "events_page_faq_2_answer", label: "FAQ 2 Answer", type: "textarea" as const, fullWidth: true },
    { key: "events_page_faq_3_question", label: "FAQ 3 Question" },
    { key: "events_page_faq_3_answer", label: "FAQ 3 Answer", type: "textarea" as const, fullWidth: true },
    { key: "events_page_faq_4_question", label: "FAQ 4 Question" },
    { key: "events_page_faq_4_answer", label: "FAQ 4 Answer", type: "textarea" as const, fullWidth: true },
    { key: "events_page_faq_5_question", label: "FAQ 5 Question" },
    { key: "events_page_faq_5_answer", label: "FAQ 5 Answer", type: "textarea" as const, fullWidth: true },
  ],
  photography_page_content: [
    { key: "photography_page_title", label: "Section Title", placeholder: "Professional Photography Services in Bangladesh" },
    { key: "photography_page_description", label: "Long Description (HTML)", type: "richtext" as const, fullWidth: true },
    { key: "photography_page_motto", label: "Motto / Tagline", placeholder: "Capturing moments that last forever" },
    { key: "photography_page_image_1", label: "Image 1", type: "image_upload" as const },
    { key: "photography_page_image_2", label: "Image 2", type: "image_upload" as const },
    { key: "photography_page_image_3", label: "Image 3", type: "image_upload" as const },
    { key: "photography_page_faq_1_question", label: "FAQ 1 Question" },
    { key: "photography_page_faq_1_answer", label: "FAQ 1 Answer", type: "textarea" as const, fullWidth: true },
    { key: "photography_page_faq_2_question", label: "FAQ 2 Question" },
    { key: "photography_page_faq_2_answer", label: "FAQ 2 Answer", type: "textarea" as const, fullWidth: true },
    { key: "photography_page_faq_3_question", label: "FAQ 3 Question" },
    { key: "photography_page_faq_3_answer", label: "FAQ 3 Answer", type: "textarea" as const, fullWidth: true },
    { key: "photography_page_faq_4_question", label: "FAQ 4 Question" },
    { key: "photography_page_faq_4_answer", label: "FAQ 4 Answer", type: "textarea" as const, fullWidth: true },
    { key: "photography_page_faq_5_question", label: "FAQ 5 Question" },
    { key: "photography_page_faq_5_answer", label: "FAQ 5 Answer", type: "textarea" as const, fullWidth: true },
  ],
  bouquet_page_content: [
    { key: "bouquet_page_title", label: "Section Title", placeholder: "Custom Bouquet Builder - Design Your Own Bouquet" },
    { key: "bouquet_page_description", label: "Long Description (HTML)", type: "richtext" as const, fullWidth: true },
    { key: "bouquet_page_motto", label: "Motto / Tagline", placeholder: "Every bouquet tells a story" },
    { key: "bouquet_page_image_1", label: "Image 1", type: "image_upload" as const },
    { key: "bouquet_page_image_2", label: "Image 2", type: "image_upload" as const },
    { key: "bouquet_page_image_3", label: "Image 3", type: "image_upload" as const },
    { key: "bouquet_page_faq_1_question", label: "FAQ 1 Question" },
    { key: "bouquet_page_faq_1_answer", label: "FAQ 1 Answer", type: "textarea" as const, fullWidth: true },
    { key: "bouquet_page_faq_2_question", label: "FAQ 2 Question" },
    { key: "bouquet_page_faq_2_answer", label: "FAQ 2 Answer", type: "textarea" as const, fullWidth: true },
    { key: "bouquet_page_faq_3_question", label: "FAQ 3 Question" },
    { key: "bouquet_page_faq_3_answer", label: "FAQ 3 Answer", type: "textarea" as const, fullWidth: true },
    { key: "bouquet_page_faq_4_question", label: "FAQ 4 Question" },
    { key: "bouquet_page_faq_4_answer", label: "FAQ 4 Answer", type: "textarea" as const, fullWidth: true },
    { key: "bouquet_page_faq_5_question", label: "FAQ 5 Question" },
    { key: "bouquet_page_faq_5_answer", label: "FAQ 5 Answer", type: "textarea" as const, fullWidth: true },
  ],
  cloudinary: [
