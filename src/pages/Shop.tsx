      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4 sm:mb-5 md:mb-6">
        ...
        <div className="relative w-full sm:w-auto">
          <select
            ...
            className="w-full sm:w-[200px] md:w-[220px] appearance-none text-xs sm:text-sm bg-card border border-border rounded-xl px-4 py-2.5 pr-9 outline-none text-foreground cursor-pointer shadow-sm hover:border-primary/40 focus:border-primary focus:ring-1 focus:ring-primary/20 transition-all"
          >
