  ...
  return (
    <section className="relative py-3 sm:py-4 md:py-6 lg:py-8 section-container animate-fade-in" aria-label="Featured promotions">
      <div className="relative">
        ...
        {/* Slide card */}
        <div className="overflow-hidden rounded-2xl lg:rounded-3xl relative h-[240px] sm:h-[260px] md:h-auto md:aspect-[5/2] lg:aspect-[3/1]">
            ...
            >
              <div className="flex items-center h-full px-5 sm:px-10 md:px-16 lg:px-20">
                <motion.div
                  ...
                  className="relative z-10 max-w-[48%] sm:max-w-[50%] md:max-w-md lg:max-w-lg xl:max-w-xl space-y-3 sm:space-y-4 md:space-y-5"
                >
                  <h1 className="text-[22px] sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-display font-bold text-foreground leading-[1.15] tracking-tight whitespace-pre-line">
                    {slide.title}
                  </h1>
                  <motion.div
                  ...
                  >
                    <Link
                      to={slide.link}
                      className="inline-block px-5 sm:px-7 md:px-8 py-2.5 sm:py-3 md:py-3 bg-primary text-primary-foreground text-xs sm:text-sm md:text-sm font-semibold uppercase tracking-[0.12em] rounded-md hover:bg-primary/90 transition-all duration-200 hover:shadow-md"
                    >
                      {slide.cta}
                    </Link>
                  </motion.div>
                ...
                <motion.div
                  ...
                  className="absolute right-4 sm:right-8 md:right-12 lg:right-16 top-1/2 -translate-y-1/2 w-[140px] h-[140px] sm:w-[160px] sm:h-[160px] md:w-[200px] md:h-[200px] lg:w-[240px] lg:h-[240px] xl:w-[280px] xl:h-[280px]"
                >
                  {slide.image && (
                    <img
                      src={slide.image}
