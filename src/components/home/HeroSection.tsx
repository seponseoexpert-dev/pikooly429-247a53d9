...
const HeroSection = () => {
  ...
  return (
    <section className="relative py-3 sm:py-4 md:py-6 lg:py-8 section-container" aria-label="Featured promotions">
      <div className="relative overflow-hidden rounded-2xl lg:rounded-3xl transition-colors duration-300" style={{ backgroundColor: slide.bgColor }}>
        <div className="flex items-center min-h-[200px] sm:min-h-[240px] md:min-h-[300px] lg:min-h-[380px] xl:min-h-[420px] px-5 sm:px-8 md:px-12 lg:px-16">
          <div className="max-w-[55%] sm:max-w-xs md:max-w-sm lg:max-w-md xl:max-w-lg">
      ...
      <div className="flex items-center justify-center gap-2 mt-3">
        ...
        {heroSlides.map((_, i) => (
          <button
            ...
            className={`h-2 rounded-full transition-all duration-200 ${i === current ? "w-6 bg-foreground" : "w-2 bg-border"}`}
