  ...
  return (
    <article className="group relative flex flex-col h-full bg-white rounded-xl border border-[hsl(0_0%_92%)] overflow-hidden shadow-[0_1px_3px_rgba(0,0,0,0.04)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.08)] transition-shadow duration-300">
      ...
      <div className="p-3 flex flex-col flex-1">
        {/* Title — 3 lines on mobile with ellipsis, 2 on desktop */}
        <Link to={linkTo}>
          <h3 className="text-[14px] sm:text-[15px] text-[hsl(0_0%_12%)] line-clamp-3 sm:line-clamp-2 leading-[1.3] font-semibold min-h-[3.9em] sm:min-h-[2.6em]">
            {product.name}
          </h3>
        </Link>
